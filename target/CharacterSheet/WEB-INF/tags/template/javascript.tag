...
<%--<script src="<c:url value="/_ui/js/lib/backbone.js"/>"></script>--%>
<%--<script src="<c:url value="/_ui/js/lib/marionette.js"/>"></script>--%>
<%--Custom files--%>
<%--<script src="<c:url value="/_ui/js/main.js"/>"></script>--%>
