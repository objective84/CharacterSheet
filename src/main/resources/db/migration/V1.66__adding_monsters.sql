...
INSERT INTO charactersheet.monster_language (id, language_id, monster_id) VALUES
  ...
  ('9', '8', '2'),
  ('10', '9', '2');
INSERT INTO monster_actions (id, name, toHitBonus, target, `range`, type, description, monster_id) VALUES
  ('1', 'Multiattack', '0', NULL , null, null, 'The aboleth makes three tentacle attacks.', '1'),
