...
INSERT INTO `charactersheet`.`spellmodel` (`id`,`name`,`level`,`school`,`ritual`,`castingTime`,`range`,`requiresVerbalComponent`,`requiresSomaticComponent`,`materialComponent`,`duration`,`concentration`,`description`,`damageDiceAmount`,`damageDice_id`,`damageType_id`,`savingThrow`,`condition`,`target`,`requiresAttackRoll`)
VALUES ('291', #id
