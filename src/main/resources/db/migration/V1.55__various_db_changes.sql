...
UPDATE `charactersheet`.`dice` SET `average-roll`='4' WHERE `id`='2';
UPDATE `charactersheet`.`dice` SET `average-roll`='5' WHERE `id`='3';
UPDATE `charactersheet`.`dice` SET `average-roll`='6' WHERE `id`='4';
UPDATE `charactersheet`.`dice` SET `average-roll`='7' WHERE `id`='5';
UPDATE `charactersheet`.`dice` SET `average-roll`='11' WHERE `id`='6';
UPDATE `charactersheet`.`dice` SET `average-roll`='51' WHERE `id`='7';
UPDATE `charactersheet`.`dice` SET `average-roll`='3' WHERE `id`='1';
