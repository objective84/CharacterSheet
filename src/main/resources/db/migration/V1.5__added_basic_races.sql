...
INSERT INTO `charactersheet`.`racemodel_languagemodel` (`races_id`, `languages_id`) VALUES ('2', '3');
INSERT INTO `charactersheet`.`racemodel_languagemodel` (`races_id`, `languages_id`) VALUES ('2', '1');

INSERT INTO `charactersheet`.`racemodel_languagemodel` (`races_id`, `languages_id`) VALUES ('3', '1');
INSERT INTO `charactersheet`.`racemodel_languagemodel` (`races_id`, `languages_id`) VALUES ('3', '7');

INSERT INTO `charactersheet`.`racemodel_languagemodel` (`races_id`, `languages_id`) VALUES ('4', '1');
