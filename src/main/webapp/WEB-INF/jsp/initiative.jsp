...
<div id="initiative">
  <div class="side-by-side float-right">
    ...
    <br/>
    <input class="hide dm-pw" type="text" id="dm-pw">
  </div>
  <div class="side-by-side">
    ...
    <div class="clear"></div>
    <div class="side-by-side" id="size-modifiers">
    ...
    <div class="side-by-side" id="action-modifiers">
      <table class="table-border">
        <th>Action</th><th>Initiative Modifier</th>
        <tr>
    ...
    <div class="table-border side-by-side">
      <span>Roll: <span id="initiative-roll"></span></span>  <br/>

      <span>Total Modifiers: <span id="initiative-modifier"></span></span>  <br/>

      <span>Total Initiative: <span id="initiative-total"></span></span>
    </div>
    <div class="clear"></div>
    <br/>
    <input style="margin-left: 460px;" type="button" id="calculate" value="Roll Initiative"> <span id='no-reroll' class="hide error">Roll already submitted!</span>
    <br/>
    <br/>
